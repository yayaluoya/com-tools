...
var BaseDataProxy = /** @class */ (function (_super) {
    ...
    BaseDataProxy.prototype.getLocalData = function (_data) {
        ...
        if (_data) {
            ...
            //删除本地数据
            LocalStorage_1.LocalStorage_.removeItem(this.name);
            //
            LocalStorage_1.LocalStorage_.setItem(this.name, _data, function (s) {
            ...
            data = LocalStorage_1.LocalStorage_.getItem(this.name, function (s) {
    ...
    BaseDataProxy.prototype.save = function () {
        var _this = this;
        LocalStorage_1.LocalStorage_.setItem(this.name, this.data, function (s) {
            return _this.dataHandle(s, 'set');
        });
    };
